...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    ...
    this.messageService.add('Colección: obteniendo celular.'); // Agrega un mensaje al servicio MessageService
  ...
  getHero(id: number): Observable<Hero> {
    ...
    this.messageService.add(`Colección: Id de celular = ${id}`); // Agrega un mensaje al servicio MessageService
